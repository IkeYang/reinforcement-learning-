...
# # print('Linear')
# lossT,lossV,acc=trainLinear(maxiter=10,wp=(6,6),lamuda=0.00,printOut=True,t=4,k0=20)
# with open('TradHMRes','wb') as f:
#     pickle.dump((lossT,lossV,acc),f)
with open('TradHMRes','rb') as f:
...
axs[1].plot(acc)
plt.show()
# f.savefig('TradHMRes.png', dpi=600, bbox_inches='tight')
